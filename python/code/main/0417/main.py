...
def read_settings():
    ...
    print('ax: {0:.2%-f}, ay: {1:.2%-f}, az: {2:.2%-f}'.format(mpu_data[0]['x'], mpu_data[0]['y'], mpu_data[0]['z']))
    print('gx: {0:.2%-f}, gy: {1:.2%-f}, gz: {2:.2%-f}'.format(mpu_data[1]['x'], mpu_data[1]['y'], mpu_data[1]['z']))
